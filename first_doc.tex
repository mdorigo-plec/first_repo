...
\urlstyle{same}
\hypersetup{
  pdftitle={First vesion control project},
  pdfauthor={Martina Dorigo},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{First vesion control project}
...
This report documents my first attempt of using Git and Github to
version control on RStudio project. I will be modifying this report,
staging and committing changes to GitHub.
